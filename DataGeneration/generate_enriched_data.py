...
- Populates tenants table with financial health scores, credit ratings
...
def generate_company_name(industry):
    ...
    tech_words = ["Tech", "Software", "Digital", "Cloud", "Data", "Cyber", "AI", "Quantum", "Nexus"]
    healthcare_words = ["Health", "Medical", "Care", "Wellness", "Life", "Bio", "Pharma", "Clinic"]
    finance_words = ["Capital", "Financial", "Investment", "Ventures", "Advisors", "Wealth", "Trust"]
    retail_words = ["Retail", "Market", "Store", "Shop", "Goods", "Boutique", "Outlet"]
    ...
    elif industry == "Retail" or industry == "Restaurant":
